...
{
    //解码表
    const char DecodeTable[] = {-2, -2, -2, -2, -2, -2, -2, -2, -2, -1, -1, -2, -2, -1, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -1, -2, -2, -2, -2,
...
int main()
{
	...
	std::string st = bs->Encode(buf, 1);

	std::cout << st.c_str() << std::endl;

	std::string r = bs->Decode(st.c_str(), st.length());
